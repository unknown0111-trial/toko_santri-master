<form action="{{ url('/karyawan/' . $karyawan->karyawan_id . '/update_ajax') }}" method="POST" id="form-edit">
    @csrf
    @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="departemen" value="{{ $karyawan->departemen }}" class="form-control" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telepon" value="{{ $karyawan->no_telepon }}" class="form-control" required>
